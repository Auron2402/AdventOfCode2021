...
def get_loosing_board_and_number(bingoboards, bingonumbers):
    winning_boards = [False] * 100
    ...
    for bingonumber in bingonumbers:
        ...
        for bingoboard in bingoboards:
            bingoboard.draw_number(bingonumber)
            if bingoboard.check_if_bingo():
                winning_boards[bingoboard_index] = True
                all_won = True
...
def main():
    with open("../input.txt") as f:
        ...
        loosing_board, winning_number = get_loosing_board_and_number(bingoboards, bingonumbers)
        sum_of_umarked_numbers = loosing_board.get_sum_of_all_unmarked_numbers()
